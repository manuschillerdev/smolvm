//! Internal boot subprocess entrypoint.
//!
//! Embedding binaries that use smolvm as a crate can expose a hidden `_boot-vm`
//! subcommand and delegate to [`run`].

use crate::agent::boot_config::BootConfig;
use crate::agent::{launch_agent_vm, LaunchConfig, VmDisks};
